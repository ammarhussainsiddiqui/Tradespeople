            ...
            <>
              <div className="flex w-full flex-col space-y-4  md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div className="flex flex-col space-y-2 sm:space-y-0 sm:flex-row sm:space-x-4 md:flex-col md:space-x-0 md:space-y-2 items-start md:items-end">
                  ...
                  {lead?.status === "Closed" ? (
                    <div className="w-full sm:w-auto bg-destructive text-destructive-foreground text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 rounded-2xl border border-neutral-300 text-center">
                      This job is closed.
                    </div>
                  ) : (
                    <>
                      {reveal ? (
                        ...
                        <>
                          {revealLoading ? (
                            <button
                              disabled
                              className="w-full sm:w-auto bg-accent text-accent-foreground hover:bg-primary hover:text-ink-inverse text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 rounded-md border border-neutral-300"
                            >
                              <Spinner />
                            </button>
                          ) : (
                            <button
                              onClick={() => checkReveal()}
                              className="w-full sm:w-auto bg-accent hover:bg-primary hover:text-ink-inverse text-accent-foreground text-sm sm:text-base font-semibold px-4 sm:px-6 py-2 rounded-md border border-neutral-300"
                            >
                    ...
                    <>
                      ...
                      <p className="text-sm text-foreground font-bold">
                        {!user?.phone || user?.phone == undefined ? (
                          ...
                          <i><button className="px-1 py-1 rounded-full bg-accent text-accent-foreground hover:text-ink-inverse">
                            <svg
              ...
              {reveal && (
                <p className="text-success mt-auto">
                  Great! Now you can contact this lead to discuss the project
                  details. Wish you all the best!
                </p>
              )}
            </>
          )}
